...
if keyword_set(commands) then begin
    ...
    table_name='tables/my_commands.tex' 
    OPENW,1,table_name
    ...
    printf,1,'\newcommand{\rawunwise}{469,037,483\xspace}'
    printf,1,'\newcommand{\rawukidss}{84,440,794\xspace}'
    printf,1,'\newcommand{\rawtwom}{470,992,970\xspace}'
    printf,1,'\newcommand{\rawgalex}{\xspace}'

    printf,1,'\newcommand{\ninit}{3,108,935\xspace}'
    printf,1,'\newcommand{\nisdss}{3,062,042\xspace}'
    printf,1,'\newcommand{\nizsupp}{3,672\xspace}'
    printf,1,'\newcommand{\nixdqso}{46,893\xspace}'
    printf,1,'\newcommand{\niwise}{3,108,935\xspace}'
    printf,1,'\newcommand{\niunwise}{3,108,723\xspace}'
    printf,1,'\newcommand{\niukidss}{952,866\xspace}'
    printf,1,'\newcommand{\nitwom}{122,607\xspace}'
    printf,1,'\newcommand{\nigalex}{322,527\xspace}'
    printf,1,'\newcommand{\nicha}{365,678\xspace}'
    printf,1,'\newcommand{\nixmm}{2,888,401\xspace}'
    printf,1,'\newcommand{\ninst}{45,985\xspace}'
    printf,1,'\newcommand{\nichaxmm}{158,173\xspace}'
    printf,1,'\newcommand{\nichanst}{11,802\xspace}'
    printf,1,'\newcommand{\nixmmnst}{32,497\xspace}'
    ...
    printf,1,'\newcommand{\nfgalex}{0\xspace}'
    printf,1,'\newcommand{\nfcha}{365,678\xspace}'
    printf,1,'\newcommand{\nfxmm}{2,888,401\xspace}'
    printf,1,'\newcommand{\nfnst}{45,985\xspace}'
    printf,1,'\newcommand{\nfchaxmm}{158,173\xspace}'
    printf,1,'\newcommand{\nfchanst}{11,802\xspace}'
    printf,1,'\newcommand{\nfxmmnst}{32,497\xspace}'
